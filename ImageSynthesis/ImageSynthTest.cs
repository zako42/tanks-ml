...
public class ImageSynthTest : MonoBehaviour
{
    // pass configuration
    ...
    public RenderTexture segmentation;
    ...
    void Start()
    {
        ...
        segmentationCam = CreateHiddenCamera("segmentation");
        depthCam = CreateHiddenCamera("depth");
        // segmentationCam.targetTexture = segmentation;
    ...
    public void OnCameraChange()
    {
        ...
        segmentationCam.CopyFrom(mainCamera);
        segmentationCam.targetTexture = segmentation;
